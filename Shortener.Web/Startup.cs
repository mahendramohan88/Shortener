...
using Shortener.Web.Middleware;
...
namespace Shortener
{
    public class Startup
    {
        ...
        // This method uses a database with the default connection string but can be overriden for integration testing with another database.
